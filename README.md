...
This dashboard was built to answer three questions a Product/Business Analyst would realistically be asked:
...
*Note: CLTV here uses a simplified annualized-revenue approach. A more rigorous model would incorporate actual churn rate (`ARPU ÷ Churn Rate`) to reflect variable customer lifespans — this was intentionally simplified to match the course methodology this project was built alongside.*
...
Built by **Sakshi Chamoli** as a portfolio project.
